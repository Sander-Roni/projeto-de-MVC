...
public class CompraCliente extends javax.swing.JFrame {
    DAO dao = new DAO();
    ChamadoPgto chamadoPgto = new ChamadoPgto();
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Visao/image-removebg-preview (30).png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 255, 153));
        jLabel3.setText("Numero do Cartao");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String numero_cartao = jTextField2.getText();
        String validade = jTextField3.getText();
        String cvv = jTextField4.getText();
        String endereco = jTextField5.getText();
        chamadoPgto.setTitular(titular);
        chamadoPgto.setNumero_cartao(numero_cartao);
        chamadoPgto.setValidade(validade);
        chamadoPgto.setCvv(cvv);
        chamadoPgto.setEndereco(endereco);
        try{
            dao.RealizarCompra(chamadoPgto);
