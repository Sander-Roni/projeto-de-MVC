 ...
 * @author Anuli
 */
public class PesquisarDoCliente extends javax.swing.JFrame {
    DAO dao = new DAO();
    ChamadoLivros chamadoLivros = new ChamadoLivros();
    /**
     * Creates new form TelaDoCliente
     */
    public PesquisarDoCliente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Pesquise um Livro...");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            dao.PesquisarLivros(chamadoLivros);
            jTextField2.setText(chamadoLivros.getTitulo());
            jTextField3.setText(chamadoLivros.getAutor());
            jTextField4.setText(chamadoLivros.getGenero());
            jTextField6.setText(chamadoLivros.getAno_publicacao());
            jTextField7.setText(chamadoLivros.getEditora());
            jTextField9.setText(chamadoLivros.getIdioma());
        }catch (SQLException | ClassNotFoundException ex) {
            java.util.logging.Logger.getLogger(PesquisarDoCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        LivroVirtual tp = new LivroVirtual();
        tp.setVisible(rootPaneCheckingEnabled);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        CompraCliente tp = new CompraCliente();
        tp.setVisible(rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarDoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarDoCliente().setVisible(true);
            }
        });
    }
